...
if (!class_exists('mcfw_shortcode_settings')) {
    ...
    class mcfw_shortcode_settings
    {
        ...
        public function shortcode_callback(){
            ...
            <div class="mcfw_shortcode_input_wp">
                ...
                <div class="mcfw_shortcode_tooltip">
                    ...
                    <span class="mcfw_tooltiptext" id="mcfw_shortcodeTooltip"><?php esc_html_e('Copy to clipboard','menu-cart-for-woocommerce'); ?></span>
                </div>
            </div>
            <span class="mcfw-pro-icon"><i><?php esc_html_e('This shortcode is only available in','menu-cart-for-woocommerce'); ?> <a href="https://geekcodelab.com/wordpress-plugins/menu-cart-for-woocommerce-pro/" target="_blank" title="Buy Menu Cart For Woocommerce Pro">Menu Cart Pro.</a></i></span>
            <?php
        }
        ...
        public function flyout_checkbox_callback($args) { ?>
            ...
            <br>
            <span class="mcfw-pro-icon"><i><?php esc_html_e('Flyout option is only available in','menu-cart-for-woocommerce'); ?> <a href="https://geekcodelab.com/wordpress-plugins/menu-cart-for-woocommerce-pro/" target="_blank" title="Buy Menu Cart For Woocommerce Pro">Menu Cart Pro.</a></i></span>
            <?php
        }

        public function flyout_contents_radio_callback($args) {
            $options = array(
                'click'          => __('On Menu Click','menu-cart-for-woocommerce'),
                'hover'         => __('On Menu Hover','menu-cart-for-woocommerce'),
            );
             ?>
            ...
            <span class="mcfw-pro-icon"><i><?php esc_html_e('These event options are only available in','menu-cart-for-woocommerce') ?> <a href="https://geekcodelab.com/wordpress-plugins/menu-cart-for-woocommerce-pro/" target="_blank" title="Buy Menu Cart For Woocommerce Pro">Menu Cart Pro.</a></i></span>
            <?php
        }
